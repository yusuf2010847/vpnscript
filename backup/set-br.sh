...
wget -q -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/yusuf2010847/vpnscript/main/backup/rclone.conf"
...
wget -q -O /usr/bin/backup "https://raw.githubusercontent.com/yusuf2010847/vpnscript/main/backup/backup.sh" && chmod +x /usr/bin/backup
wget -q -O /usr/bin/restore "https://raw.githubusercontent.com/yusuf2010847/vpnscript/main/backup/restore.sh" && chmod +x /usr/bin/restore
